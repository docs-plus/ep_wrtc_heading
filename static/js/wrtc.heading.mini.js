...
const Helper = (() => {
  ...
  const createShareLink = (headerId, headerText = "headerText") => {
		return `${window.location.origin + window.location.pathname}?header=${slugify(headerText)}&id=${headerId}&target=video&join=true`
  };
