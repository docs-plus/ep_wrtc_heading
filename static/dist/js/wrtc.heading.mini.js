...
export const init = (context) => (ace = context.ace);
export const getValidUrl = function () {
  const url =
...
export const wrtcStore = {
  ...
  wrtcPubsub.on('socket state', (state) => {
    console.log(state, "333333", wrtcStore.socketState)
    wrtcStore.socketState = state;
    console.log(state, "333333", wrtcStore.socketState)
    setTimeout(() => {
    console.log(state, "333333332223", wrtcStore)
...
export default (() => {
  ...
  function roomBtnHandler(actions, headerId, target) {
    ...
    console.log(Helper.wrtcStore.socketState , Helper.wrtcStore)
