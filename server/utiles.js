...
module.exports.shortSequentialId = function () {
  ...
  const findNextId = (stringId) => {
    ...
    if (!REGEX.test(stringId)) { throw new Error('The input must contain one letter and several numbers'); }
...
exports.objectHasPath = (obj, prop) => {
  if (typeof obj === 'object' && obj !== null) { // only performs property checks on objects (taking care of the corner case for null as well)
    ...
    for (const p in obj) { // otherwise iterate on all the properties of this object
